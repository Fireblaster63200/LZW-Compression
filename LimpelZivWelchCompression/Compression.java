...
public class Compression 
{
	...
	*/
	...
	{
		String input,compression;
		double percentage;
		System.out.print("Enter any string to compress : ");
		input = new Scanner(System.in).nextLine();
		compression = new Compression().compress(new FileHandling(input).read());
		new FileHandling("","test.vesp").write(compression);
	}
